    ...
    await Promise.all([
      ...
      permissionRepository.save(
        permissionRepository.create({
          ...
          descripcion: "Permite leer información de un usuario específico (ej. por ID)"
        }),
      ),
      permissionRepository.save(
        permissionRepository.create({
          nombre: "user:update_all",
          descripcion: "Permite actualizar información de cualquier usuario"
        }),
      ),
      permissionRepository.save(
        permissionRepository.create({
      ...
      permissionRepository.save(
        permissionRepository.create({
          ...
          descripcion: "Permite actualizar información de un usuario específico"
        }),
      ),
      permissionRepository.save(
        permissionRepository.create({
      ...
      permissionRepository.save(
        permissionRepository.create({
          ...
          descripcion: "Permite leer la lista de todos los permisos disponibles en el sistema"
        }),
      ),
      permissionRepository.save(
        permissionRepository.create({
          nombre: "dashboard:view_admin",
          descripcion: "Permite ver el panel de administración general"
        }),
      ),
      permissionRepository.save(
        permissionRepository.create({
          nombre: "settings:manage_general",
          descripcion: "Permite gestionar configuraciones generales del sistema"
        }),
      ),
      permissionRepository.save(
        permissionRepository.create({
